                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(child: const Text('Create an account',
                        style: TextStyle(
                      ...
                      ElevatedButton(
                          onPressed:(){
                            _loginController.postLogin(context,userController,passwordController);
                            },
                          child: const Text(
                            'Log in',
  ...
  Widget buildTabButton(int tabIndex, String text) {
    return TextButton(
      ...
      child: Container(
        ...
        height: 30,
        width: 110,
        decoration: BoxDecoration(color: index == tabIndex ? const Color.fromRGBO(228, 213, 201, 1): Colors.transparent,borderRadius: BorderRadius.circular(25)),
        child: Center(
          child: Text(
            text,
            style: TextStyle(
              ...
              SizedBox(
                ...
                child: DropdownButtonFormField(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(
                      value: "Ferizaj",
                      child: Text("Ferizaj", style: TextStyle(color: Colors.white)),
                    ),
                    DropdownMenuItem(
                      value: "Prishtine",
                      child: Text("Prishtine", style: TextStyle(color: Colors.white)),
                    ),
                    DropdownMenuItem(
                      value: "Gjilan",
                      child: Text("Gjilan", style: TextStyle(color: Colors.white)),
                    ),
                    DropdownMenuItem(
                      value: "Peje",
                      child: Text("Peje", style: TextStyle(color: Colors.white)),
                    ),
                  ],
                  onChanged: (value) {
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Tel',
                    contentPadding: const EdgeInsets.only(left: 20),
                    hintStyle: const TextStyle(color: Color.fromRGBO(228, 213, 201, 1)),
                  ),
                ),
              ),
              SizedBox(
                ...
                width: MediaQuery.of(context).size.width - 60,
                child: TextFormField(
                  validator: (value){if(value!.isEmpty){return 'please add comment';}},
                  maxLines: 3,
                  style: const TextStyle(color: Colors.white),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        onPressed:(){_loginController.postLogin(context,userController,passwordController);},
                        child: const Text(
                          'Log in',
                          style: TextStyle(color: Colors.black),
                        )),
