...
import 'package:business_menagament/features/presentation/screens/business_admin/add_transaction_category.dart';
...
class _AddNewCostScreenState extends State<AddNewCostScreen> {
  ...
  addNewCost() async {
    ...
    if (punetor == true) {
      ...
      await businessProvider.addNewExpense(
          context, jsonEncode(transactionModel.toJson2()));
    }
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.inter(
                              fontSize: 15,
                              color:_transactionCategoryModel == null
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          fetchingEmployees
                              ? AppLocalizations.of(context)!.loadingEmployee
                              : employeeModel == null
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10),
                        borderSide: const BorderSide(color: Color(0xffebedef))),
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => TransactionCategoryScreen()));
            },
            child: Center(
              child: Text(
