...
class _CheckoutUpdateScreenState extends State<CheckoutUpdateScreen> {
  ...
  startDay() async {
    ...
    if (_price.text.isEmpty) {
      showErroModal(context, AppLocalizations.of(context)!.startPriceCheckoutAlert);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(
          "${widget.isOpen! ? AppLocalizations.of(context)!.closeCashbox : AppLocalizations.of(context)!.openCashbox}  ",
                ...
                if (pickedDate != null) {
                  if (widget.isOpen == false) {
                    if (pickedDate.isBefore(
                      ...
                      showErroModal(
                          context, AppLocalizations.of(context)!.laterDateNeeded,
                          size: 18);
                    } else {
                    ...
                    if (checkoutProvider.getActiveCheckout() != null) {
                      if (pickedDate.isBefore(DateFormat('yyyy-MM-dd').parse(
                          checkoutProvider.getCheckoutModel()!.startedDate!))) {
                        showErroModal(
                            context, AppLocalizations.of(context)!.biggerDateAlert,
                            size: 18);
                      } else if (pickedDate.isAfter(DateFormat('yyyy-MM-dd')
                          .parse(checkoutProvider
                              .getCheckoutModel()!
                              .startedDate!))) {
                        showErroModal(context,
                            AppLocalizations.of(context)!.dateBiggerThanCheckoutDate,
                            size: 18);
              ...
              child: Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      hintText:
                          widget.isOpen! ? AppLocalizations.of(context)!.closingValue: AppLocalizations.of(context)!.incomeValue,
